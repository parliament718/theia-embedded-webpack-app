...
export declare class FileSystemMainImpl implements FileSystemMain, Disposable {
    ...
    private readonly providersBySchema;
    ...
    private getHandle;
    $stat(uriComponents: UriComponents): Promise<FileStat>;
    $readDirectory(uriComponents: UriComponents): Promise<[string, FileType][]>;
    $createDirectory(uriComponents: UriComponents): Promise<void>;
    $readFile(uriComponents: UriComponents): Promise<string>;
    $writeFile(uriComponents: UriComponents, content: string): Promise<void>;
    $delete(uriComponents: UriComponents, options: {
        recursive: boolean;
    }): Promise<void>;
