...
export declare class GitDiffContribution extends AbstractViewContribution<GitDiffWidget> implements TabBarToolbarContribution {
    ...
    constructor(selectionService: SelectionService, widgetManager: WidgetManager, app: FrontendApplication, quickOpenService: GitQuickOpenService, fileSystem: FileSystem, openerService: OpenerService, notifications: MessageService, scmService: ScmService);
