...
var common_3 = require("@theia/core/lib/common");
...
describe('WorkspaceService', function () {
    ...
    beforeEach(function () {
        ...
        testContainer.bind(common_3.MessageService).toConstantValue({});
    ...
    describe('constructor and init', function () {
        ...
        it('should set the exposed roots and workspace to the folders listed in the workspace file returned by the server, ' +
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        workspaceFilePath = '/home/workspaceFile.theia-workspace';
        ...
        it('should set the exposed roots an empty array if the workspace file stores invalid workspace data', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        workspaceFileUri = 'file:///home/workspaceFile.theia-workspace';
                        workspaceFileStat = {
                            uri: workspaceFileUri,
                            lastModification: 0,
                            isDirectory: false
    ...
    describe('onStop() function', function () {
        ...
        it('should send server the uri of current workspace if there is workspace opened', function () {
            var uri = 'file:///home/testUri.theia-workspace';
    ...
    describe('removeRoots() function', function () {
        ...
        it('should update the workspace file with remaining folders', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should emit updated roots when workspace file is changed', function (done) {
        var workspaceFileUri = 'file:///home/workspaceFile.theia-workspace';
    ...
    describe('isWorkspaceFile()', function () {
        it("should return true for '" + common_2.THEIA_EXT + "' files", function () { return __awaiter(void 0, void 0, void 0, function () {
            var uri, stat, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        uri = "/home/foo/bar." + common_2.THEIA_EXT;
                        stat = {
                            uri: uri,
                            lastModification: 0,
                            isDirectory: false
                        ...
                        _a = expect;
                        return [4 /*yield*/, wsService['isWorkspaceFile'](stat)];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).equal(true);
                        return [2 /*return*/];
                }
            });
        }); });
        it("should return true for '" + common_2.VSCODE_EXT + "' files", function () { return __awaiter(void 0, void 0, void 0, function () {
            var uri, stat, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        uri = "/home/foo/bar." + common_2.VSCODE_EXT;
                        stat = {
                            uri: uri,
                            lastModification: 0,
                            isDirectory: false
        ...
        it("should return false if not a '" + common_2.THEIA_EXT + "' or '" + common_2.VSCODE_EXT + " file", function () { return __awaiter(void 0, void 0, void 0, function () {
            var uri, stat, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        uri = '/home/foo/foo.bar';
                        stat = {
                            uri: uri,
                            lastModification: 0,
                            isDirectory: false
                        ...
                        return [4 /*yield*/, wsService['isWorkspaceFile'](stat)];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).equal(false);
                        return [2 /*return*/];
                }
            });
        }); });
